...
{
    public class MenuLogHandler : KdtFieldEntityEx
    {
        ...
        protected override string _mainTable { get { return "menu_log"; } }
        ...
        protected override Dictionary<string, string> _UpdateWhere
        {
            ...
            {
                Dictionary<string, string> dic = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
                dic.Add("menu_log", "where auto_no=[@Autono] ");
                return dic;
            }
        }
        ...
        private KdtFeildEx _autono = new KdtFeildEx() { TableName = "menu_log", FeildName = "auto_no", IsKey = true, IsIncr = true };
        public KdtFeildEx Autono { get { return _autono; } set { _autono = value; } }

        private KdtFeildEx _name = new KdtFeildEx() { TableName = "menu_log", FeildName = "menu_name" };
        public KdtFeildEx MenuName { get { return _name; } set { _name = value; } }

        private KdtFeildEx _moudle = new KdtFeildEx() { TableName = "menu_log", FeildName = "oper_moudle" };
        public KdtFeildEx OperMoudle { get { return _moudle; } set { _moudle = value; } }

        private KdtFeildEx _type = new KdtFeildEx() { TableName = "menu_log", FeildName = "oper_type" };
        public KdtFeildEx OperType { get { return _type; } set { _type = value; } }

        private KdtFeildEx _content = new KdtFeildEx() { TableName = "menu_log", FeildName = "oper_content" };
        public KdtFeildEx Content { get { return _content; } set { _content = value; } }

        private KdtFeildEx _creator = new KdtFeildEx() { TableName = "menu_log", FeildName = "creator" };
        public KdtFeildEx Creator { get { return _creator; } set { _creator = value; } }

        private KdtFeildEx _ctime = new KdtFeildEx() { TableName = "menu_log", FeildName = "create_time" };
